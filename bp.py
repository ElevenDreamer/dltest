...
class Connections(object):
    def __init__(self):
        self.connections = []
    def add_connection(self, conncetion):
        self.connections.append(conncetion)
    def dump(self):
...
class Network(object):
    def __init__(self, layers):
        ...
        for layer in range(layer_count - 1):
            connections = [Conncetion(upstream_node, downstream_node)
...
if __name__ == '__main__':
    ...
    net.dump()
    correct_ratio(net)
    test(net, (int)(random.uniform(0, 256)))
    gradient_check_test()
